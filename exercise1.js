...
let KILLGIT = 0
function iHateTheAntichrist() {
    let total = document.getElementById("your-total-clicks")
    KILLGIT++
    total.innerHTML = KILLGIT
}

//i didnt read any of the commented instructions LMAO i just ran the live server and guessed what to do